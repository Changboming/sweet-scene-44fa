...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/sweet-scene-44fa)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-scene-44fa
```

A live public deployment of this template is available at [https://sweet-scene-44fa.templates.workers.dev](https://sweet-scene-44fa.templates.workers.dev)
